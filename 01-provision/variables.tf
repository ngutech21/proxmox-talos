...
variable "vm_ip_cidr" {
  description = "CIDR prefix length recorded for node IP metadata"
  type        = number
  default     = 24
...
variable "vm_gateway" {
  description = "Default gateway recorded for node IP metadata"
  type        = string
...
variable "vm_dns_servers" {
  description = "DNS servers recorded for node IP metadata"
  type        = list(string)
  default     = ["1.1.1.1"]
